...
INSERT INTO Employees (EmployeeID, LastName, FirstName, Title, BirthDate, HireDate, City, PostalCode, Country)
VALUES (EmployeeID_seq.NEXTVAL, 'Doe', 'John', 'Directeur', TO_DATE('12-04-1975', 'DD-MM-YYYY'), TO_DATE('01-01-2005', 'DD-MM-YYYY'), 'Paris', '75001', 'France');
